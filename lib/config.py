...
sentinel_cfg = QuazConfig.tokenize(sentinel_config_file)
sentinel_version = "1.1.0"
min_quazd_proto_version_with_sentinel_ping = 80000


def get_quaz_conf():
    home = os.environ.get('HOME')

    quaz_conf = os.path.join(home, ".quazcore/quaz.conf")
    if sys.platform == 'darwin':
        quaz_conf = os.path.join(home, "Library/Application Support/QuazCore/quaz.conf")

    quaz_conf = sentinel_cfg.get('quaz_conf', quaz_conf)
