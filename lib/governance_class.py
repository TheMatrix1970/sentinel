...
class GovernanceClass(object):
    ...
    def list(self):
        ...
        # return a dict similar to quazd "gobject list" output
    ...
    def quazd_serialise(self):
        import quazlib
        return quazlib.SHIM_serialise_for_quazd(self.serialise())
